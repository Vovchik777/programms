...
while tochka !='.':
    ...
    window = Tk()
    window.title('Работа с canvas')
    canvas = Canvas(window, width=250, height=250, bg="gray", cursor="pencil")
    canvas.create_text(200, 200, text="Конец игры", font="Verdana 12", justify=CENTER, fill="blue")
    canvas.create_text(100, 100, text="Чтобы продолжить играть напишите * чтобы закончить напишите .", font="Verdana 12", justify=CENTER, fill="blue")
    canvas.pack()
    window.mainloop()
    tochka = input()
